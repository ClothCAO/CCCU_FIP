<template>
  ...
  <div class="home" >
    <div class="header">
      <mt-header fixed :title="articleName"><!--title前不加冒號會無法傳入變量articleName-->
        <router-link :to="{ name: 'createArticle', params: {salesID: salesID}}" slot="left">
    ...
    <div class="Qbottom w3-animate-bottom" v-show="questionShow"><!--底部帮助栏-->
      <span>幫助</span>
      <span>撤回</span>
      <span>刪除</span>
      <span>重做</span>
    ...
    <div class="bottom" v-show="bottomShow"> <!--底部欄-->
 ...
 // components:{createArticle},
  ...
  methods:{
    ...
    publish:function(){
      ...
      let salesID = salesID
      axios.post('',{article,name,salesID,eventID})
