<template>
  <div>
    ...
    <form class="w3-container">
      ...
      <router-link :to="{ name: 'test', params: {salesID: salesID, eventID: eventID} }">
      <p class="w3-center"><button @click='submit()' class="w3-btn w3-center w3-black w3-text-white w3-margin-top">Add article</button></p>
      </router-link>-->
    </form>
  </div>
</template>
