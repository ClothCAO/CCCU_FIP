  ...
  <div>
    ...
    <div class="w3-margin-left w3-container">
      ...
      <form class="w3-margin-right w3-container w3-white w3-padding-large" style="margin-left:20%">
        ...
        <br>
        <p>Event Start Date and Time: <input type="datetime-local" v-validate="{required: true}" class="w3-input" placeholder="Start Date" name="startDateTime" ref="startDateTime" v-model="startDateTime"></p>
        <span class="w3-text-red">{{ errors.first('startDateTime') }}</span>
        <br>
        <p>Event End Date and Time: <input type="datetime-local" v-validate="{required: true, after: startDateTime}" class="w3-input" placeholder="End Date" name="endDateTime" v-model="endDateTime"></p>
